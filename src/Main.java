        ...
        while(true) {
            ...
            switch(cho) {
                case 1:
                    ...
                    System.out.println("Enter 1 for giving suggestion");
                    System.out.println("Enter 2 to get top 5 profiter");
                    System.out.println("Enter 3 to get top 5 looser ");
                    ...
                    switch(ich){
                        case 1:
                            ...
                            if (choice.equalsIgnoreCase("yes")) {
                                ...
                                String q2 = "INSERT INTO suggestions (Category, SuggestedSymbol) VALUES (?, ?) " +
                                        "ON DUPLICATE KEY UPDATE SuggestedSymbol=?";
                            ...
                            break;
                        case 2:
                            String qpl="SELECT Mail_id, SUM(ProfitLoss) AS TotalProfit FROM adminprofitloss GROUP BY Mail_id ORDER BY TotalProfit DESC LIMIT 2";
                            ...
                            break;
                        case 3:
                            String qpl1="SELECT Mail_id, SUM(ProfitLoss) AS TotalProfit FROM adminprofitloss GROUP BY Mail_id ORDER BY TotalProfit LIMIT 2";
